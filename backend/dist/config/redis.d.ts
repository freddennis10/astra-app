...
export declare const setCache: (key: string, value: any, expiration?: number) => Promise<void>;
export declare const getCache: (key: string) => Promise<any>;
export declare const deleteCache: (key: string) => Promise<void>;
export declare const setCacheWithTTL: (key: string, value: any, ttl: number) => Promise<void>;
export declare const setSession: (sessionId: string, userId: string, data: any) => Promise<void>;
...
export declare const incrementRateLimit: (identifier: string, windowMs: number) => Promise<number>;
export declare const publishToChannel: (channel: string, message: any) => Promise<void>;
