 ...
 * /api/posts/feed:
 *   get:
 *     summary: Get personalized AI-curated feed
 *     tags: [Posts]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 */
router.get('/feed', (req: any, res: any) => {
  const { page = 1, limit = 10 } = req.query;
  
  // Mock AI-curated feed
  const feed = {
 ...
 * /api/posts/create:
 *   post:
 *     summary: Create new post with AI assistance
 *     tags: [Posts]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
...
router.post('/create', [
  ...
  try {
    ...
    // Enhanced content with AI (if requested)
 ...
 */
router.post('/ai-generate', (req: any, res: any) => {
 ...
 * /api/posts/trending:
 *   get:
 *     summary: Get trending posts with AI analysis
 *     tags: [Posts]
 *     security:
 *       - bearerAuth: []
 *     responses:
 ...
 *   get:
 *     summary: Get detailed post analytics
 *     tags: [Posts]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 */
router.get('/:id/analytics', (req: any, res: any) => {
  const { id } = req.params;
